...
final public class LabelsRender {
    final public class GeometryDescriptor {
        ...
        public convenience init(
            ...
            let textOriginX = normalizedRect.origin.x + normalizedRect.size.width * textOffstFactor
            let textOriginY = normalizedRect.origin.y + normalizedRect.size.height * textOffstFactor
            let textWidth = normalizedRect.size.width * (1 - textOffstFactor * 2)
            let textHeight = normalizedRect.size.height * (1 - textOffstFactor * 2)
