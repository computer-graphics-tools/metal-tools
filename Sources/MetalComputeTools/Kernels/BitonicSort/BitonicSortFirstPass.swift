...
extension BitonicSort {
    /// Represents the first pass of the Bitonic Sort algorithm.
    final class FirstPass {
        ...
        /// Initializes a new FirstPass instance using a Metal context.
        ///
        /// - Parameters:
        ...
        /// Initializes a new FirstPass instance using a Metal library.
        ///
        /// - Parameters:
        ...
        init(
            ...
            self.pipelineState = try library.computePipelineState(
                function: "bitonicSortFirstPass" + `extension`,
        ...
        /// Encodes the first pass of the sorting operation into a command buffer.
        ///
        /// - Parameters:
        ...
        /// Encodes the first pass of the sorting operation using a compute command encoder.
        ///
        /// - Parameters:
        ///   - data: The buffer containing the data to be sorted.
        ///   - elementStride: The stride between elements in the buffer.
